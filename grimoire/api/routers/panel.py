...
def _build_settings_out(db: Session) -> PanelSettingsOut:
    ...
    return PanelSettingsOut(
        summarization_api=SummarizationApiSettingsOut(
            ...
            api_mode=api_settings.api_mode,
        ...
        summarization=SummarizationPromptSettingsOut(
            ...
            chat_system_prompt=summarization_settings.chat_system_prompt,
            chat_user_prompt=summarization_settings.chat_user_prompt,
            segmented_memory_chat_system_prompt=summarization_settings.segmented_memory_chat_system_prompt,
            segmented_memory_chat_user_prompt=summarization_settings.segmented_memory_chat_user_prompt,
